...
This repository is the **frontend** (Next.js). It talks to a separate **Laravel API** ([cadence-api](https://github.com/maricastroc/cadence-api)) over HTTP, with authentication handled by a secure **httpOnly session cookie**.
